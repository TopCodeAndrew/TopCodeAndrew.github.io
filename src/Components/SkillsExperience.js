                ...
                <span className="projects-box">
                    <span className="single-project-box">
                        ...
                        <span className="description-box">
                            <div className="title">
                                ...
                                <div className="icons">
                                    <img
                                        ...
                                        onClick={() =>
                                            openNewTab(
                                                "https://github.com/TopCodeAndrew/MoDoFlo"
                                            )
                                        }
                                    />
                                </div>
                            ...
                            <p>
                                {" "}
                                Originally designed to assist Andrew to easily
                                use the popular Pomodoro productivity technique,
                                modoflo is now available to anyone on the web.{" "}
                                <br></br> <br></br>
                                Features:<br></br>
                                <ol>
                                    <li>- Full authentication functionality</li>
                                    <li>
                                        - Use of redux to store user details
                                    </li>
                                    <li>
                                        - Database integration tracks progress
                                        on projects
                                    </li>
                                    <li>
                                        - Stripe integration to accept donations
                                    </li>
                                </ol>
                            </p>
                        </span>
                        ...
                        <span className="description-box">
                            <div className="title">
                                ...
                                <img
                                    ...
                                    onClick={() =>
                                        openNewTab(
                                            "https://github.com/TopCodeAndrew/noDBproject"
                                        )
                                    }
                                />
                            </div>
                            <p>
                                {" "}
                                Change-Squared is a simple, easy-to-use styling
                                editor. A personal challenge in this project was
                                to create it without using any redux to store
                                variables, resulting in more complicated
                                prop-drilling.<br></br> <br></br>
                                Features:<br></br>
                                <ol>
                                    <li>
                                        - Creating and editing 4-sided shapes
                                    </li>
                                    <li>
                                        - Ability to name shapes (hidden
                                        feature)
                                    </li>
                    ...
                    <span className="single-project-box">
                        ...
                        <span className="description-box">
                            <div className="title">
                                ...
                                <div className="icons">
                                    ...
                                    <img
                                        ...
                                        onClick={() =>
                                            openNewTab(
                                                "https://github.com/Lemon-Prop-Management/lemon-prop"
                                            )
                                        }
                                    />
                                </div>
                            ...
                            <p>
                                {" "}
                                LemonProp.com is the property management
                                software created for a hypothetical company,
                                "LemonProp Management". As the lead developer
                                for this project, Andrew participated first-hand
                                in guiding his team through agile software
                                development practices. <br></br> <br></br>
                                Features:<br></br>
                                <ol>
                                    <li>
                                        - Extensive use of authentication
                                        middleware
                                    </li>
                                    <li>
                                        - Tracks tenants, payments, and
                                        maintenance requests for all properties
                                    </li>
                                    <li>
                                        - Ability for tenants to pay rent online
                                    </li>
                                </ol>
                            </p>
                        </span>
